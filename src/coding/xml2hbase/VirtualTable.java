...
public class VirtualTable {
	...
	{// reset all currentNumber 1
		...
		Set<Entry<String,List<CodeandNumber>>> set1 = virtualTable.entrySet();   
	      Iterator<Entry<String, List<CodeandNumber>>>   it = set.iterator();   
	      while(it.hasNext()) {   
	             Entry e = it.next();
	             ...
	             for(Iterator<CodeandNumber> itr = valueList.iterator();itr.hasNext();) 
	             {
	            	 ...
	            	 CodeandNumber nextObj = itr.next();
	            	 System.out.println(nextObj.getTotalChildNumber()+",   "+nextObj.getcurrentChildNumber());
